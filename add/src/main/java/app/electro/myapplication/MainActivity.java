package app.electro.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInfo.setText(String.format("Выберите ближайшую заправку :", stInfo));
...
/////////////////////////D10////////////////////////////
    ...
    public void onClickBut8(View v) {
        Button myBtn= (Button) findViewById(R.id.button4);
        a=!a;

        if((myThreadConnected!=null)&&(a)) {


            myBtn.setText("Остановить");
            byte[] bytesToSend = "6".getBytes();
            myThreadConnected.write(bytesToSend );
        }
        if((myThreadConnected!=null)&&(!a)) {
            myBtn.setText("Заряжать");
    ...
    public void onClickBut9(View v) {
        Button myBtn= (Button) findViewById(R.id.button6);
        c=!c;

        if((myThreadConnected!=null)&&(c)) {


            myBtn.setText("Скейтборд");
            byte[] bytesToSend = "1".getBytes();
            myThreadConnected.write(bytesToSend );
        }
        if((myThreadConnected!=null)&&(!c)) {
            myBtn.setText("Велосипед");
